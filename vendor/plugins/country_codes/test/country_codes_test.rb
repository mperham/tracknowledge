...
class CountryCodesTest < Test::Unit::TestCase
  ...
  def test_country_options_for_select
    assert_equal 246, CountryCodes.prioritized_countries_for_select(['usa', 'gbr']).size
    assert_equal 'gbr', CountryCodes.prioritized_countries_for_select(['usa', 'gbr'])[1][1]

    assert_not_nil CountryCodes.country_options_for_select
    assert_not_nil CountryCodes.country_options_for_select('usa', ['usa', 'gbr'])
  end
end
